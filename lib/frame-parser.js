...
frame_parser[C.FRAME_TYPE.BLUETOOTH_UNLOCK_RESPONSE] = function (frame, reader, options) {
  frame.id = reader.nextUInt8();
  // frame.command = reader.nextString(2, 'ascii');
  frame.commandParameter = reader.nextAll();
}

frame_parser[C.FRAME_TYPE.USER_DATA_RELAY_OUTPUT] = function (frame, reader, options) {
  frame.interface = reader.nextUInt8();
  frame.commandParameter = reader.nextAll();
}