...
ft.BLUETOOTH_UNLOCK = 0x2C;
ft[0x2C] = "Bluetooth Unlock (0x2C)";
ft.BLUETOOTH_UNLOCK_RESPONSE = 0xAC;
ft[0xAC] = "Bluetooth Unlock Response (0xAC)";
ft.USER_DATA_RELAY = 0x2D;
ft[0x2D] = "User Data Relay";
ft.USER_DATA_RELAY_OUTPUT = 0xAD;
ft[0xAD] = "User Data Relay Output (0xAD)";